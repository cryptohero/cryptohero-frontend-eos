...
const networkSetting = {
  mainnet: {
    rpcApi: 'https://mainnet.EOS.io',
  },
  testnet: {
    rpcApi: 'https://testnet.EOS.io',
  },
};
...
export default class Contract {
  ...
  /**
     ...
     * The smart contract must have been submited.
     * @param: functionName - The name of the function
     * @param: value - How many EOS NAS should cost
     * @param: data - Function arguement, please enter arguement in ordered array
     * @param: options - please check https://github.com/EOSio/scatter/blob/master/doc/NebPay%E4%BB%8B%E7%BB%8D.md#options
     */
